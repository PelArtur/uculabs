...
def results():
    ...
    print(f'Правильні слова -{userwordsindict}')
    print(f'Усі можливі слова-{dictlist}')
    print(f'Пропущені слова -{userwordsnotindict}')
    print(f'Слова, які є відсутніми в словнику -{pureuserwords}')
